...
const MOCK_TRANSFERS: TransferItem[] = [
  // ── 확정 ────────────────────────────────────────────────────────────────
  {
    ...
    toTeam:   "Tottenham",      toTeamKo:   "토트넘",           toFlag:   "🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    fee: "Extension", status: "confirmed", window: "Summer 2026", windowKo: "2026 여름",
    date: "2026-04-02", age: 33, nationality: "South Korea", nationalityKo: "대한민국",
  ...
  },
  {
    ...
    fee: "€55M", status: "confirmed", window: "Summer 2026", windowKo: "2026 여름",
